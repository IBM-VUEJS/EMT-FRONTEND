...
const clients = [
    ...
    },
    {
        ...
        type: 'Entreprise Privée',
        pays: 'BENIN',
        produit_service: 'COMMUNICATION SERVICE',
        statut: 'Inactif',
    },
    {
        numero: 'CLT_2407',
    ...
    },
    {
        ...
        type: 'Entreprise Privée',
        pays: 'GHANA',
        produit_service: 'ENERGY SERVICE',
        statut: 'Inactif',
    },
    {
        numero: 'CLT_2409',
        ...
        type: 'Entreprise Publique',
        pays: 'NIGER',
        produit_service: 'AIRLINE SERVICE',
        statut: 'Actif',
    },
    {
        numero: 'CLT_2410',
...
const archiveclientFunc = () => {
    Swal.fire({
            ...
            text: 'Êtes-vous sûr de vouloir archiver cet client ?',
            icon: 'warning',
            ...
            (result) => {
                if(result.isConfirmed) {
                    Swal.fire(
                        {
                            text: 'Le client a été archivé avec succès',
                            icon: 'success',
                        ...
                        <div class="filter_form" v-if="hideFilter">
                            ...
                            <h5 class="popup_title">Filtrer la liste</h5>
                                <form action="" @submit.prevent="">
                                    ...
                                    <SelectComponent :options="pays" :border="'1px solid var(--grey)'" :libel="'Type'" :bottom="'10px'"></SelectComponent>
